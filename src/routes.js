...
const routes = [
 { path: '/app/', exact: true, name: 'Home', component: DefaultLayout },
  ...
  { path: '/app/base/dropdowns', name: 'Dropdowns', component: Dropdowns },
  ...
  { path: '/app/buttons', exact: true, name: 'Buttons', component: Buttons },
  { path: '/app/buttons/buttons', name: 'Buttons', component: Buttons },
  { path: '/app/buttons/button-dropdowns', name: 'Button Dropdowns', component: ButtonDropdowns },
  ...
  { path: '/app/icons/font-awesome', name: 'Font Awesome', component: FontAwesome },
  { path: '/app/icons/simple-line-icons', name: 'Simple Line Icons', component: SimpleLineIcons },
  { path: '/app/notifications', exact: true, name: 'Notifications', component: Alerts },
